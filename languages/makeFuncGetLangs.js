...
const currentLang = global.GoatBot?.config?.language || global.FloppaBot?.config?.language || "en";
let pathLanguageFile = `${__dirname}/${currentLang}.lang`;
if (!fs.existsSync(pathLanguageFile)) {
	log.warn("LANGUAGE", `Can't find language file ${currentLang}.lang, using default language file "${__dirname}/en.lang"`);
