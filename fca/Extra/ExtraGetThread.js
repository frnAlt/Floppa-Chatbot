...
const fs = require("fs");
const userLang = (global.Fca && global.Fca.Require && global.Fca.Require.Priyansh && global.Fca.Require.Priyansh.Language) || "en";
language = (language.find(i => i.Language == userLang) || language[0]).Folder.ExtraGetThread;
const Always_True = [];
